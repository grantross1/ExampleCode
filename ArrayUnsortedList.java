...
{
    protected final int DEFCAP = 10000; // default capacity
    ...
    protected int compare;    // set by find method
    ...
    // not successful, sets found to false.
    {
        location = 0;
        found = false;
        while (location < numElements && !found) 
        {
            compare++;
            search++;
    ...
    {
        String listString = "Array Unsorted List:\n";
        for (int i = 0; i < numElements; i++)
